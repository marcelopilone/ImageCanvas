...
patchBrowser().then(options => {
  return index.bootstrapLazy([["image-canvas.cjs",[[0,"image-canvas",{"bgImg":[1,"bg-img"],"wCanvas":[2,"w-canvas"],"hCanvas":[2,"h-canvas"],"canvasFillStyle":[1,"canvas-fill-style"],"fontCanvas":[1,"font-canvas"],"content":[16],"imgLoading":[32]}]]]], options);
});
