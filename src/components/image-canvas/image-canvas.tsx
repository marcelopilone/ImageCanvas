...
export class ImageCanvas {
  ...
  @Prop() imageBackgroundUrl: string = 'https://afigestion.uejn.org.ar/img/ficha_afiliado.png'
  @Prop() widthCanvas: number = 1014
  @Prop() heightCanvas: number = 644
  @Prop() json_data: any[] =  [
      {
  ...
  render() {
    return (
      <Host>
        <canvas id="canvas" width={this.widthCanvas} height={this.heightCanvas}></canvas>
      </Host>
    )
  }
